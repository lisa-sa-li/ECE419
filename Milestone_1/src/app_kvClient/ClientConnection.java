...
public class ClientConnection implements IClientConnection {
	...
	// sendTextMessage(new TextMessage("Successfully put key:" + key + ", value: " +
	// value));
	// } catch (Exception e) {
	// sendTextMessage(new TextMessage("Failed to put key:" + key + ", value: " +
	// value));
	// }
	...
	// sendTextMessage(new TextMessage("Successfully get key:" + key + ", value is:
	// " + kvStoreValue));
	// } catch (Exception e) {
